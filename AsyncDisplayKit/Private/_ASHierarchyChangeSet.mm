...
- (void)_validateUpdate
{
  ...
  if (_reloadDataChange) {
    if (_originalDeleteItemChanges || _originalDeleteSectionChanges
        || _originalInsertSectionChanges || _originalDeleteItemChanges
        || _reloadSectionChanges || _reloadItemChanges) {
