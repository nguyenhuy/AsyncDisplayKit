...
- (ASSectionContext *)dataController:(ASDataController *)dataController contextForSectionAtIndex:(NSInteger)sectionIndex
{
  if (_asyncDataSourceFlags.asyncDataSourceContextForSectionAtIndex) {
    ASSectionContext *context = [_asyncDataSource collectionView:self contextForSectionAtIndex:sectionIndex];
    if (context != nil) {
