...
- (nullable id<ASSectionContext>)dataController:(ASDataController *)dataController contextForSectionAtIndex:(NSInteger)sectionIndex;
...
- (nullable id<ASSectionContext>)contextForSectionAtIndex:(NSInteger)sectionIndex;
